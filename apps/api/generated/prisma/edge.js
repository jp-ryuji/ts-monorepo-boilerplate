...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/ryuji.eguchi/src/github.com/jp-ryuji/ts-monorepo-boilerplate/apps/api/generated/prisma',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
    ...
    previewFeatures: [],
    sourceFilePath:
      '/Users/ryuji.eguchi/src/github.com/jp-ryuji/ts-monorepo-boilerplate/apps/api/prisma/schema.prisma',
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineSchemaHash:
    '84f13f7f66111fd60b00a1263b87b4bc23a30665af36daf43c96cb7fc957f538',
  copyEngine: true,
};
config.dirname = '/';
